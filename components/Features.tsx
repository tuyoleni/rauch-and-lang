...
export function Features({ data }: FeaturesProps) {
  ...
  return (
    <section ref={sectionRef} id="features" className="py-24 max-w-7xl mx-auto">
      <motion.h2
        initial={{ opacity: 0 }}
        ...
        {data.features.map((feature, index) => (
          ...
          >
            ...
            <div className="absolute inset-0 flex flex-col justify-end p-6">
              ...
              <motion.p
                className="text-sm text-[#a19b8c] opacity-0 transform translate-y-4 transition-all duration-500 group-hover:opacity-100 group-hover:translate-y-0"
                initial={{ y: 20, opacity: 0 }}
                whileInView={{ y: 0, opacity: 1 }}
